        ...
        <div class="row">
            ...
            <div class="content">
                ...
                if (isset($_POST['sr_btn'])) {
                    ...
                    $single = $conn->query("SELECT stat_id, COUNT(*) as countP FROM attendance WHERE stat_id='$sr_id' AND course = '$course' AND st_status='Present'");
                ...
                if (isset($_POST['sr_date'])) {
                    ...
                    $all_query = $conn->query("SELECT * FROM attendance WHERE stat_date='$sdate' AND course = '$course'");
                }
                if (isset($_POST['sr_date'])) {
