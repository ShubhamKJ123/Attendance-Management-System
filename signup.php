...
try {
    if (isset($_POST['signup'])) {
        ...
        // Validate inputs
        if (empty($_POST['email']) || empty($_POST['uname']) || empty($_POST['pass']) || empty($_POST['fname']) || empty($_POST['phone']) || empty($_POST['type'])) {
      ...
      $stmt = $pdo->prepare("INSERT INTO admininfo (username, password, email, fname, phone, type) VALUES (?, ?, ?, ?, ?, ?)");
      $stmt->execute([$_POST['uname'], $_POST['pass'], $_POST['email'], $_POST['fname'], $_POST['phone'], $_POST['type']]);
  ...
  <div class="row">
    ...
    <form method="post" class="form-horizontal col-md-6 col-md-offset-3">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" name="email"  class="form-control" id="input1" placeholder="xyv@gmail.com" />
          </div>
      </div>
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" name="uname"  class="form-control" id="input1" placeholder="eg: ram123" />Remember for Login
          </div>
      </div>
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" name="fname"  class="form-control" id="input1" placeholder="eg:Ram Kumar" />
          </div>
      </div>
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" name="phone"  class="form-control" id="input1" placeholder="10-digit" />
          </div>
      </div>
